...
class Kyc_Infotemp(models.Model):
    ...
    house_no_temp = models.CharField(max_length=20, blank=True, null=True)
    street_temp = models.CharField(max_length=20, blank=True, null=True)
    city_temp = models.CharField(max_length=20, blank=True, null=True)
