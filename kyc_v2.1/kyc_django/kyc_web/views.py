...
def add_kyc_submit(request):
    ...
    kyc_info = KycInfo(name_init=name_init, full_name=full_name, company_name=company_name, address_full=address_full, email_add=email_add, phone_num=phone_num, long_text=long_text)
    kyc_info.save()
    return render(request, "kyc_web/index.html")
